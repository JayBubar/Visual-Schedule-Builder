...
export const styles: { [key: string]: React.CSSProperties } = {
    ...
    gridContainer: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', width: '80%' },
    ...
    cycleContainer: { marginTop: '2rem', background: 'rgba(0,0,0,0.1)', padding: '1rem', borderRadius: '12px', textAlign: 'center', color: 'white' },
    cycleText: { margin: 0, fontWeight: 600 },
    cycleGraphic: { fontSize: '2rem', marginTop: '0.5rem' },
